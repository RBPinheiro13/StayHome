...
(function() { "use strict";
  ...
  sprite_sheet = {
    ...
    frame_sets:[[0], [2], [3]],// standing still, walk right, walk left
    image:new Image()
  ...
  render = function() {
    ...
    buffer.lineWidth = buffer.canvas.height/4;
    buffer.beginPath();
    buffer.moveTo(0, 0);
    buffer.bezierCurveTo(buffer.canvas.height, buffer.canvas.height/2, buffer.canvas.height, 0, buffer.canvas.width, 0);
    buffer.moveTo(0, 0);
    buffer.bezierCurveTo(buffer.canvas.height,buffer.canvas.height/2, buffer.canvas.height, buffer.canvas.height/2, buffer.canvas.width, 0);
    buffer.stroke();
    buffer.fillStyle = "#009900";
    buffer.fillRect(0, buffer.canvas.height-4, buffer.canvas.width, 4);
  ...
  sprite_sheet.image.src = "ichigo.png";// Start loading the image.
